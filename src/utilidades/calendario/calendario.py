...
def verif_feriado(mes,dia):
    ...
    elif (dia == 14 and mes == 5):
        return 1

    elif (dia == 15 and mes == 5):
        return 1
...
def verif_fin_semana(año,mes,fecha):
...
###fines_semana(año,mes,fecha)
###feriado(fecha,mes)

if(verif_feriado(mes,fecha)):
    feriado(año,mes,fecha)

elif(verif_fin_semana(año,mes,fecha)):
    fines_semana(año,mes,fecha)
else:
    dia_correspondiente(zeller(año,mes,fecha))
    print("SE TRABAJA")
